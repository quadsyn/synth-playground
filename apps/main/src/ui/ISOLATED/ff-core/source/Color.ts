...
import type { IVector3 } from "./Vector3.js";
import type { IVector4 } from "./Vector4.js";

////////////////////////////////////////////////////////////////////////////////

export { Vector3, Vector4 };
export type { IVector3, IVector4 }
...
export class Color
{
    ...
    setString(color: string, alpha: number = 1, throws: boolean = true): Color
    {
        ...
        color = Color.presets[color as keyof typeof Color.presets] || color;
