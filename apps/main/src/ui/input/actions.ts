...
export const enum ActionKind {
    ...
    SetSoundClipTimeStretchModeToHighQuality,
    ResetSoundClipPlaybackRate,
    ResetSoundClipPitchShift,
    MultiplySoundClipPlaybackRateByTwo,
    DivideSoundClipPlaybackRateByTwo,
...
(<ActionTableEntry[]>[
    ...
    [
        ActionTags.ShowInCommandPalette,
        ActionKind.SetSoundClipTimeStretchModeToHighQuality,
        AreaKind.Timeline,
        [],
        <ActionId>"timeline.setSoundClipTimeStretchModeToHighQuality",
        StringId.TimelineActionSetSoundClipTimeStretchModeToHighQuality,
    ],
    [
        ActionTags.ShowInCommandPalette,
    ...
    [
        ActionTags.ShowInCommandPalette,
        ActionKind.MultiplySoundClipPlaybackRateByTwo,
        AreaKind.Timeline,
        [],
        <ActionId>"timeline.multiplySoundClipPlaybackRateByTwo",
        StringId.TimelineActionMultiplySoundClipPlaybackRateByTwo,
    ],
    [
        ActionTags.ShowInCommandPalette,
        ActionKind.DivideSoundClipPlaybackRateByTwo,
        AreaKind.Timeline,
        [],
        <ActionId>"timeline.divideSoundClipPlaybackRateByTwo",
        StringId.TimelineActionDivideSoundClipPlaybackRateByTwo,
    ],
    [
        ActionTags.ShowInCommandPalette,
